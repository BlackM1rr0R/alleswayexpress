...
function HomePage({ setPage, lang = "de" }) {
  ...
  return (
    <>
      ...
      {/* ══════════════ WHY US ══════════════ */}
      <section className="section" style={{ backgroundImage: `url(${kamyon3})`, backgroundSize: "100% auto", backgroundPosition: "center 40%", backgroundAttachment: "fixed", position: "relative" }}>
        <div className="section-bg-overlay" />
        <div className="section-inner">
          <div className="section-header">
      ...
      {/* ══════════════ TESTIMONIALS ══════════════ */}
      <section className="section section-dark" style={{ backgroundImage: `url(${kamyon4})`, backgroundSize: "100% auto", backgroundPosition: "center 60%", backgroundAttachment: "fixed", position: "relative" }}>
        <div className="section-bg-overlay" />
        <div className="section-inner">
          <div className="section-header">
