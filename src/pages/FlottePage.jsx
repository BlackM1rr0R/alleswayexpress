...
const CONTENT = {
  de: {
    ...
    vehicles: [
      ...
      { img: lkw3, icon: "🚚", name: "Actros 40 t", price: "ab 11,00 €/km", nutzlast: "24 t", laderaum: "90 m³", coverage: "Deutschlandweit", features: ["Schwertransport bis 24t", "Wechselbrückensystem", "GPS Echtzeit-Tracking", "48h Lieferzeit DE"] },
    ...
    table_rows: [
      ...
      ["🚚 Actros 40 t", "24 t", "ab 11,00 €/km", "48 h", "Deutschlandweit", "Schwertransporte"],
  ...
  en: {
    ...
    vehicles: [
      ...
      { img: lkw3, icon: "🚚", name: "Actros 40 t", price: "from €11.00/km", nutzlast: "24 t", laderaum: "90 m³", coverage: "Nationwide", features: ["Heavy transport up to 24t", "Swap-body system", "GPS real-time tracking", "48 h delivery DE"] },
    ...
    table_rows: [
      ...
      ["🚚 Actros 40 t", "24 t", "from €11.00/km", "48 h", "Nationwide", "Heavy transport"],
