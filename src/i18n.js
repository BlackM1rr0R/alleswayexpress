  ...
  de: {
    ...
    services: {
      ...
      fleet_cards: [
        ...
        { icon: "🚚", name: "Actros 40 t",        cap: "24 t",  vol: "90 m³", range: "Deutschlandweit", color: "green", specs: ["Bis 24.000 kg Nutzlast", "90 m³ Laderaum", "Wechselbrückensystem", "GPS Echtzeit-Tracking"] },
      ],
    ...
    about: {
      ...
      awards: [
        { year: "2023", title: "Bestes Logistikunternehmen",     org: "IHK Rhein-Neckar" },
        { year: "2024", title: "Gold Award Kundenzufriedenheit", org: "Logistik Verband DE" },
        { year: "2024", title: "Top Arbeitgeber Logistik",       org: "Focus Business" },
    ...
    contact: {
      ...
      hours_table: [
        { day: "Montag – Freitag", time: "06:00 – 20:00 Uhr", type: "full" },
        { day: "Samstag",           time: "08:00 – 16:00 Uhr", type: "partial" },
        { day: "Sonntag",           time: "Notdienst",          type: "emergency" },
        { day: "Feiertage",         time: "Notdienst",          type: "emergency" },
      ],
  ...
  en: {
    ...
    services: {
      ...
      fleet_cards: [
        ...
        { icon: "🚚", name: "Actros 40 t",        cap: "24 t",  vol: "90 m³", range: "Nationwide",      color: "green", specs: ["Up to 24,000 kg payload", "90 m³ cargo space", "Swap body system", "GPS real-time tracking"] },
      ],
    ...
    about: {
      ...
      awards: [
        { year: "2023", title: "Best Logistics Company",       org: "IHK Rhein-Neckar" },
        { year: "2024", title: "Gold Award Customer Satisfaction", org: "Logistics Association DE" },
        { year: "2024", title: "Top Employer Logistics",       org: "Focus Business" },
    ...
    contact: {
      ...
      hours_table: [
        { day: "Monday – Friday", time: "06:00 – 20:00",  type: "full" },
        { day: "Saturday",         time: "08:00 – 16:00",  type: "partial" },
        { day: "Sunday",           time: "Emergency only",  type: "emergency" },
        { day: "Public holidays",  time: "Emergency only",  type: "emergency" },
      ],
